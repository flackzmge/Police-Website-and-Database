...
#DROP FOREIGN KEY fk_incident_vehicle;
#Alter table incident
#DROP FOREIGN KEY fk_incident_people;
#Alter table incident
#Drop FOREIGN KEY fk_incident_offence;

#alter table fines
# DROP FOREIGN KEY Incident_ID;


#ALTER TABLE Ownership
 # DROP FOREIGN KEY  fk_people;
...
# Check for identity option to automatically check for keys
...
INSERT INTO People (People_ID, People_Firstname,People_Lastname, People_address, People_licence) VALUES
...
INSERT INTO Vehicle (Vehicle_ID, Vehicle_type, Vehicle_colour, Vehicle_licence) VALUES
(23, 'BMW M3', 'Yellow', 'NY64KWD');




DROP TABLE IF EXISTS PoliceUser;
CREATE TABLE PoliceUser (
    PoliceUser_ID INT(11) NOT NULL,
    PoliceUser_username VARCHAR(10) NOT NULL,
    PoliceUser_Firstname VARCHAR(50) NOT NULL,
    PoliceUser_Lastname VARCHAR(50) NOT NULL,
    PoliceUser_address VARCHAR(50) NOT NULL,
    PoliceUser_password VARCHAR(15) DEFAULT NULL,
	PoliceUser_admin TINYINT(1) NOT NULL
)  ENGINE=INNODB DEFAULT CHARSET=LATIN1;

INSERT INTO PoliceUser (PoliceUser_ID,PoliceUser_username,PoliceUser_Firstname,PoliceUser_Lastname,PoliceUser_address,PoliceUser_password,PoliceUser_admin) VALUES
(1, 'McNulty', 'Jimmy','McNulty', ' 48 Sunninghill Drive, Nottingham','plod123',0),
(2, 'Moreland', 'William','Moreland', '3 Fisher Lane, Nottingham','fuzz42',0),
(3, 'psxng3', 'Nathan' ,'Gilbert-Grosvenor', '85 Wolds Drive, Nottingham','checastro',0),
(4, 'Daniels','Cedric','Daniels','Byron House, 4 Maid Marian Way, Nottingham NG1 6HS','copper99',1),
(5, 'SReeves', 'Stuart',' Reeves', ' 22 Central Avenue, Nottingham','studio123',0);
...
ALTER TABLE PoliceUser
  ADD PRIMARY KEY (PoliceUser_ID);
  
ALTER TABLE PoliceUser
  MODIFY PoliceUser_ID int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
